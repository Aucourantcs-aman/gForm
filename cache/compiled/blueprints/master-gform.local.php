...
return [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.recaptcha-form.enabled' => [
                'type' => 'toggle',
                'label' => 'PLUGIN_ADMIN.PLUGIN_STATUS',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.recaptcha-form.enabled',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.subject_toggle' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.recaptcha-form.subject_toggle',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.name_field_type' => [
                'type' => 'select',
                ...
                'default' => 'full_name',
                'name' => 'plugins.recaptcha-form.name_field_type',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.email_toggle' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.recaptcha-form.email_toggle',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.message_toggle' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.recaptcha-form.message_toggle',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.address_toggle' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.recaptcha-form.address_toggle',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.phone_toggle' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.recaptcha-form.phone_toggle',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.country_code_toggle' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.recaptcha-form.country_code_toggle',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.company_toggle' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.recaptcha-form.company_toggle',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.terms_toggle' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.recaptcha-form.terms_toggle',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.attachment_toggle' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.recaptcha-form.attachment_toggle',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.form_custom_css' => [
                'type' => 'textarea',
                'label' => 'Custom CSS',
                'default' => '',
                'rows' => 10,
                'name' => 'plugins.recaptcha-form.form_custom_css',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.google_toggle' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.recaptcha-form.google_toggle',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.google_site_key' => [
                'type' => 'text',
                'label' => 'Google reCAPTCHA Site Key',
                'validate' => [
                    'type' => 'string'
                ],
                'name' => 'plugins.recaptcha-form.google_site_key',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.google_secret_key' => [
                'type' => 'text',
                'label' => 'Google reCAPTCHA Secret Key',
                'validate' => [
                    'type' => 'string'
                ],
                'name' => 'plugins.recaptcha-form.google_secret_key',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.cloudflare_toggle' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.recaptcha-form.cloudflare_toggle',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.cloudflare_site_key' => [
                'type' => 'text',
                'label' => 'Cloudflare Site Key',
                'validate' => [
                    'type' => 'string'
                ],
                'name' => 'plugins.recaptcha-form.cloudflare_site_key',
                'validation' => 'loose'
            ],
            'plugins.recaptcha-form.cloudflare_secret_key' => [
                'type' => 'text',
                'label' => 'Cloudflare Secret Key',
                'validate' => [
                    'type' => 'string'
                ],
                'name' => 'plugins.recaptcha-form.cloudflare_secret_key',
                'validation' => 'loose'
            ],
            'themes.quark' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'recaptcha-form' => [
                    'enabled' => 'plugins.recaptcha-form.enabled',
                    'subject_toggle' => 'plugins.recaptcha-form.subject_toggle',
                    'name_field_type' => 'plugins.recaptcha-form.name_field_type',
                    'email_toggle' => 'plugins.recaptcha-form.email_toggle',
                    'message_toggle' => 'plugins.recaptcha-form.message_toggle',
                    'address_toggle' => 'plugins.recaptcha-form.address_toggle',
                    'phone_toggle' => 'plugins.recaptcha-form.phone_toggle',
                    'country_code_toggle' => 'plugins.recaptcha-form.country_code_toggle',
                    'company_toggle' => 'plugins.recaptcha-form.company_toggle',
                    'terms_toggle' => 'plugins.recaptcha-form.terms_toggle',
                    'attachment_toggle' => 'plugins.recaptcha-form.attachment_toggle',
                    'form_custom_css' => 'plugins.recaptcha-form.form_custom_css',
                    'google_toggle' => 'plugins.recaptcha-form.google_toggle',
                    'google_site_key' => 'plugins.recaptcha-form.google_site_key',
                    'google_secret_key' => 'plugins.recaptcha-form.google_secret_key',
                    'cloudflare_toggle' => 'plugins.recaptcha-form.cloudflare_toggle',
                    'cloudflare_site_key' => 'plugins.recaptcha-form.cloudflare_site_key',
                    'cloudflare_secret_key' => 'plugins.recaptcha-form.cloudflare_secret_key'
                ]
            ],
            'themes' => [
                'quark' => [

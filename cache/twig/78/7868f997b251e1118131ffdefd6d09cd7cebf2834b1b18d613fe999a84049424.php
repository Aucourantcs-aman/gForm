  ...
  ";
    ...
    ";
            ...
            ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["tab"]) {
                    ...
                    if ((($this->getAttribute($context["tab"], "type", []) == "tab") && ((null === $this->getAttribute($context["tab"], "condition", [])) || ($this->getAttribute($context["tab"], "condition", []) == true)))) {
                        ...
                        echo "\" data-tabid=\"tab-";
                        echo twig_escape_filter($this->env, ((($context["tabsKey"] ?? null) . "-") . $this->getAttribute($context["tab"], "name", [])), "html", null, true);
        ...
        <div class=\"tabs-content\">
            ";
                // line 48
                $this->loadTemplate("forms/fields/tabs/tabs.html.twig", "forms/fields/tabs/tabs.html.twig", 48, "305599089")->display(twig_array_merge($context, ["name" => $this->getAttribute(($context["field"] ?? null), "name", []), "fields" => ($context["fields"] ?? null)]));
                // line 56
                echo "        </div>
    ";
            }
...
{% endblock %}
", "forms/fields/tabs/tabs.html.twig", "E:\\xamp-htdocs\\gravcms\\gForm\\user\\plugins\\form\\templates\\forms\\fields\\tabs\\tabs.html.twig");
    }
}


/* forms/fields/tabs/tabs.html.twig */
class __TwigTemplate_c4af3e4fc80ae65935e0048f0e53e94e98c9afa5c81cd728d2c9fc8bc3a56369___305599089 extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        parent::__construct($env);
    ...
    public function block_inner_markup_field_open($context, array $blocks = [])
    {
        // line 50
        echo "                    <div id=\"tab-";
        echo twig_escape_filter($this->env, ((($context["tabsKey"] ?? null) . "-") . $this->getAttribute(($context["field"] ?? null), "name", [])), "html", null, true);
